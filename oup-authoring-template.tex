...
\title[Short Article Title]{octopusV: correcting and standardize benchmarking of structural variant (SV) results from SV callers}

\author[1,$\dagger$]{Qingxiang Guo\ORCID{0000-0000-0000-0000}}
\author[1,$\dagger$]{Yangyang Li\ORCID{0000-0000-0000-0000}}
\author[1,2,$\ast$]{Rendong Yang\ORCID{0000-0000-0000-0000}}
%\author[3]{Fourth Author}
%\author[4]{Fifth Author\ORCID{0000-0000-0000-0000}}

\authormark{Author Name et al.}

\address[1]{\orgdiv{Department of Urology}, \orgname{Northwestern University Feinberg School of Medicine}, \orgaddress{\street{303 E Superior St}, \postcode{Chicago}, \state{IL 60611}, \country{USA}}}
\address[2]{\orgdiv{Robert H. Lurie Comprehensive Cancer Center}, \orgname{Northwestern University Feinberg School of Medicine}, \orgaddress{\street{303 E Superior St}, \postcode{Chicago}, \state{IL 60611}, \country{USA}}1}

\corresp[$\ast$]{Corresponding author. \href{email:email-id.com}{rendong.yang@northwestern.edu}}
