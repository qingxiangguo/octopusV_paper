...
# --------------------------------------
# This script runs Truvari benchmarking for the visor_pacbio dataset.
#
# Changes from previous scripts:
# - Different reference genome and truth set:
#   -b /projects/b1171/qgn1237/6_SV_VCF_merger/20241113_octopusv_final_benchmarking/Simulation_data/downloaded_SV_data_and_simulated_genome/truth_set_preparation/visor_truth_fixed_truvari_fixed.vcf.gz
#   -f /projects/b1171/qgn1237/1_my_database/GRCh38_p13/GRCh38.p13.genome.fa
#
# Also, when running VCF_savior.py, use "-g 38" due to GRCh38 reference.
#
# Use mamba run to directly execute commands in environments:
# - mamba666 for VCF_savior.py (with Python 3.6+)
# - truvari for truvari bench
# - octopusv for octopusv svcf2vcf
#
# The directory structure is similar to previous datasets, with intersection, support_threshold, union.
# Also has combisv_4callers, jasmine_4callers, survivor_4callers, svmerge_4callers.
# --------------------------------------
...
VISOR_DIR="${BASE_DIR}/visor_pacbio"
...
# 4callers sets (combisv_4callers, jasmine_4callers, survivor_4callers, svmerge_4callers, octopusv_4callers)
...
echo "All benchmark analyses completed for visor_pacbio dataset."
